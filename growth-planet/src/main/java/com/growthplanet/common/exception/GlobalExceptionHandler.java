...
public class GlobalExceptionHandler {
    ...
    private final com.growthplanet.service.FailureAuditService audit;

    public GlobalExceptionHandler(com.growthplanet.service.FailureAuditService audit) {
        this.audit = audit;
    }
    ...
    private ResponseEntity<Result<Void>> failure(ResultCode code) {
        try {
            ...
            log.error("failure_audit_unavailable requestId={} errorCode={} exceptionType={}",
                    com.growthplanet.common.context.RequestContext.requestId(), code.getCode(), ex.getClass().getSimpleName());
        }
    ...
    public ResponseEntity<Result<Void>> handleUnexpected(Exception ex) {
        log.error("unexpected_failure requestId={} exceptionType={}",
                com.growthplanet.common.context.RequestContext.requestId(), ex.getClass().getSimpleName());
